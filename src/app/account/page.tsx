...
export default async function AccountPage() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-5xl p-8">
      ...
      <p className="mt-2 text-zinc-600">Manage quotations, partnership access, payment verification and delivery progress.</p><div className="mt-7 grid gap-4 sm:grid-cols-2"><a className="rounded-xl border bg-white p-5 font-semibold shadow-sm hover:border-sky-400" href="/account/quotations">Quotations and payment proof →</a><a className="rounded-xl border bg-white p-5 font-semibold shadow-sm hover:border-sky-400" href="/account/partnership">Partnership programme →</a><a className="rounded-xl border bg-white p-5 font-semibold shadow-sm hover:border-sky-400" href="/shop">Request more products →</a></div>
