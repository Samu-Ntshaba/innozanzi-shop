    ...
    <div className="min-h-screen bg-slate-50 text-slate-950">
      <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-[1440px] items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-3 text-sm"><Link className="hidden font-semibold text-slate-600 hover:text-sky-700 sm:block" href="/shop">Continue shopping</Link><form action={logoutAction}><button className="rounded-lg border border-slate-300 px-3 py-2 font-semibold">Sign out</button></form></div>
        </div>
      </header>
