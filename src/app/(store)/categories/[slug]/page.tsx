...
export async function generateMetadata({params}:{params:Promise<{slug:string}>}):Promise<Metadata>{
  ...
  const supplier=await prisma.supplierCatalogueProduct.findFirst({where:{active:true,images:{isEmpty:false},category:{equals:slug,mode:"insensitive"},...await sellableSupplierWhere()},select:{category:true}});
