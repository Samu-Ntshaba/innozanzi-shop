...
export default function GamingLayout({children}:{children:React.ReactNode}){
  return <div className="min-h-dvh bg-[#050713]"><BehaviourSignal signal={{eventType:"GAMING_VISIT",entityType:"EXPERIENCE",entityId:"gaming",category:"Gaming",context:"gaming"}}/><GamingHeader/>{children}</div>;
}
