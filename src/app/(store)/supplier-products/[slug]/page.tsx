...
export default async function SupplierProductPage({ params, searchParams }: {
    ...
    <section id="overview" className="mt-6 scroll-mt-32 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8"><p className="text-xs font-black uppercase tracking-[.18em] text-sky-700">Product details</p><h2 className="mt-2 text-2xl font-black text-slate-950">About this product</h2>{product.description ? <div className="prose prose-slate mt-4 max-w-4xl leading-8" dangerouslySetInnerHTML={{ __html: safeSupplierHtml(product.description) }}/> : <p className="mt-4 leading-8 text-slate-700">Product information is currently unavailable.</p>}</section>
