...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen bg-[#eef1f4]">
    ...
    <details className="border-b border-slate-800 bg-[#172b3a] text-slate-200 lg:hidden">
      ...
      <AdminNav canViewRfqs={canViewRfqs} canViewMarketing={canViewMarketing} canViewDocuments={canViewDocuments} canManageUsers={canManageUsers} isSuperAdministrator={context.isSuperAdministrator} />
    </details>
