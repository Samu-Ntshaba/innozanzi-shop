      ...
      <div className="flex min-w-0 flex-1 flex-col border-t border-slate-100 p-3.5 sm:p-4">
        ...
        <div className="mt-auto pt-4">
          <div className="flex items-end justify-between gap-2">
            <div className="min-w-0"><p className="text-sm font-semibold tracking-tight text-slate-950 sm:text-base">Request a price</p><p className="text-[11px] text-slate-500">Tailored quotation</p></div>
