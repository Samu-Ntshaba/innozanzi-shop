  ...
  return (
    <footer className="mt-16 bg-[#071b33] text-slate-300">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-4 lg:px-8">
        ...
        <div><p className="font-semibold text-white">Customer care</p><ul className="mt-3 space-y-2 text-sm"><li><Link href="/contact">Talk to our team</Link></li><li><a href={whatsappUrl()} target="_blank" rel="noreferrer">WhatsApp: 071 238 4185</a></li><li><Link href="/how-to">How-to guides</Link></li><li><Link href="/policies/delivery">Delivery</Link></li><li><Link href="/policies/returns">Returns</Link></li><li><Link href="/policies/privacy">Privacy</Link></li></ul></div>
      </div>
