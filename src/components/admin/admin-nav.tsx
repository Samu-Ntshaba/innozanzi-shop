...
export const adminNavGroups = [
  ...
  ["Marketing", [["Dashboard", "/admin/marketing"],["Analytics", "/admin/marketing/analytics"],["Blog", "/admin/marketing/blog"],["Homepage", "/admin/marketing/homepage"],["Website popups", "/admin/marketing/popups"],["Global SEO", "/admin/marketing/seo"],["Page SEO", "/admin/marketing/page-seo"],["SEO audit", "/admin/marketing/audit"],["Redirects", "/admin/marketing/redirects"],["Media library", "/admin/marketing/media"],["Email marketing", "/admin/email-marketing"]]],
  ["Operations", [["Orders", "/admin/orders"], ["Logistics & transport", "/admin/logistics"], ["Returns & refunds", "/admin/returns"], ["Return fulfilment", "/admin/returns/fulfilment"], ["Distributor claims", "/admin/returns/claims"], ["Return documents", "/admin/returns/documents"], ["Delivery notes", "/admin/delivery-notes"], ["Payments", "/admin/payments"], ["Inventory", "/admin/inventory"], ["Suppliers", "/admin/suppliers"]]],
  ["Catalogue", [["Products", "/admin/products"], ["Categories", "/admin/categories"], ["Brands", "/admin/brands"], ["Promotions", "/admin/promotions"]]],
  ["Intelligence", [["Reports", "/admin/reports"], ["Return profitability", "/admin/returns/profitability"], ["Syntech AI Sync", "/admin/syntech"]]],
