...
export const adminNavGroups = [
  ...
  ["Operations", [["Orders", "/admin/orders"], ["Logistics & transport", "/admin/logistics"], ["Returns & refunds", "/admin/returns"], ["Return fulfilment", "/admin/returns/fulfilment"], ["Return documents", "/admin/returns/documents"], ["Delivery notes", "/admin/delivery-notes"], ["Payments", "/admin/payments"], ["Inventory", "/admin/inventory"], ["Suppliers", "/admin/suppliers"]]],
