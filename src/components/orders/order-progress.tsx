...
const statusRank: Record<string, number> = { PENDING: 0, AWAITING_PAYMENT: 0, PAYMENT_UNDER_REVIEW: 0, PAID: 1, PAYMENT_VERIFIED: 1, PROCESSING: 2, SOURCING_ITEMS: 2, ITEMS_RECEIVED: 2, PACKING: 2, READY_FOR_DELIVERY: 2, DISPATCHED: 6, IN_TRANSIT: 6, OUT_FOR_DELIVERY: 7, SHIPPED: 6, DELIVERED: 8, COMPLETED: 8 };
