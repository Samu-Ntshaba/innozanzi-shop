...
export function CookieConsent() {
  ...
  if (choice && !editing) return <button onClick={() => setEditing(true)} className="fixed bottom-1 left-2 z-[100] rounded border border-slate-300 bg-white px-2 py-1 text-[10px] text-slate-700 shadow">Cookie settings</button>;
