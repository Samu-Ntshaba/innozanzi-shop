...
import { estimateAIRequestCost as calculateCost, isShoppingRequest } from "./rules";
...
async function candidates(intent:ShoppingIntent):Promise<AIProduct[]>{
