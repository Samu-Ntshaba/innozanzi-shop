...
export const getAdminOrders = () => prisma.order.findMany({ include: { _count: { select: { items: true } },payments:{where:{status:"PAID"},select:{paidAt:true},orderBy:{paidAt:"desc"},take:1} }, orderBy: { createdAt: "desc" }, take: 100 });
