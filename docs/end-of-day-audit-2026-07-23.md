...
| Partnership application and manual creation | Partial | Online application, manual partner creation, review, document checks, partner workspace, requests/offers and status history | Full agreement drafting/versioning, initials, two-party e-signature, offline signed upload, renewals/amendments and final agreement mail are incomplete | Complete the legal-document lifecycle before calling partnerships complete |
