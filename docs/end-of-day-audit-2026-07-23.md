...
| Repair/replacement execution | Complete | Approval creates a linked operational job; repairs track assignment, diagnosis, parts, work, quality checks, costs and return; replacements track sourcing, allocation, packing, serials, dispatch and delivery | Production browser acceptance remains | Run one repair and one replacement with production-like accounts |
| Return/refund documents | Complete | Case record, inspection report, resolution notice, linked credit note and refund confirmation use shared branded PDF, download, editable send, send history and ownership/RBAC controls | None in the requested document workflow | Review wording with finance/support owners |
